...
//std::shared_ptr<RenderObjectImpl> implementationPointer = std::make_shared<RenderObjectImpl>(arguments...);
//std::shared_ptr<IRenderObject> renderObjectPointer = std::dynamic_pointer_cast<IRenderObject>(implementationPointer);